...
// Get registration status using prepared statement
$registration = null;
...
// Get latest payment and pass info using prepared statement
$payment = null;
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <?php if ($registration): ?>
                    <span class="badge rounded-pill 
                        ...
                        aria-label="Registration status: <?= $registration['status'] ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Status:</strong>
                                     <span class="text-success">Active</span></p>
